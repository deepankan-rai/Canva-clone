...
// const authController = require('../controllers/designController')
...
router.get('/design-image',auth , designController.get_initial_image)
router.get('/background-image',auth , designController.get_background_image)
